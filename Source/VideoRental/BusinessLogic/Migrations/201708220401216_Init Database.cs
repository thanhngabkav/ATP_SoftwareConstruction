    ...
    public partial class InitDatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.RentalRates", t => t.RentalRateID, cascadeDelete: false)
                ...
                c => new
                    {
                        ...
                        LatePricePerDate = c.Single(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.DiskTitles", "RentalRateID", "dbo.RentalRates");
            ...
            DropIndex("dbo.DiskTitles", new[] { "RentalRateID" });
