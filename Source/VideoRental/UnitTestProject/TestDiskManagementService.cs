...
namespace UnitTestProject
{
    ...
    public class TestDiskManagementService
    {
        ...
        public void TestGetStatus()
        {
            ...
            DiskManagementService diskManagementService = new DiskManagementService(mockDiskDAO.Object);
            ...
            var actualResult = diskManagementService.GetDiskStatus(diskID);
